...
void User_task0(){
    ...
    while(true){
        KernelEventFlag_t handler_event = Kernel_wait_events(KernelEventFlag_UartIn|KernelEventFlag_CmdOut);
        switch(handler_event)
        {
...
void User_task1(){
    ...
    while(true){
        KernelEventFlag_t handler_event = Kernel_wait_events(KernelEventFlag_CmdIn);
        switch(handler_event)
        {
